      ...
      >
        <div>
          <Link href="/" className="-m-1.5 p-1.5">
            <span className="sr-only">Travelling.com</span>
            <img
              className="h-12 w-auto"
              src="https://i.ibb.co/x1f8C7K/Untitled-design-removebg-preview.png"
              alt=""
            />
          </Link>
        </div>
                  ...
                  {products.map((product) => (
                    ...
                    >
                      <div className="flex h-11 w-11 flex-none items-center justify-center rounded-lg bg-gray-50 group-hover:bg-gray-200">
                        <product.icon
                          className="h-6 w-6 text-[#] group-hover:text-blue-600"
                          aria-hidden="true"
                        />
                      </div>
                      ...
                      <div className="flex-auto">
                        <a
                          href={product.href}
                          className="block font-semibold text-[#]"
                        >
                          {product.name}
                          <span className="absolute inset-0" />
                        </a>
                        <p className="mt-1 text-[#]">{product.description}</p>
                      </div>
                    </div>
                  ))}
                </div>
                ...
                <div className="grid grid-cols-2 divide-x divide-gray-900/5 bg-gray-50">
                  {callsToAction.map((item) => (
                    <a
                      key={item.name}
                      href={item.href}
                      className="flex items-center justify-center gap-x-2 p-3 text-sm font-semibold leading-6 text-[#013B94] hover:bg-gray-100"
                    >
                      <item.icon
